...
class ReferentieShredder(Shredder):
    ...
    def shred_xml_file(self, filename):
        ...
        xpaths = ['SpecialismeCode',
                  ...
                  'SpecialismeIndicatie',
                  'SpecialismeOID',
                  'SpecialismeCluster[1]/SpecialismeClusterItem[(@Key=1)]',
                  'SpecialismeCluster[1]/SpecialismeClusterItem[(@Key=2)]',
                  'IndicatieAanspraakbeperking',
                  'BeginDatum',
                  'EindDatum',
                  'VersieDatum']
        ...
        xpaths = ['SpecialismeCode',
                  ...
                  'ZorgTypeOmschrijving',
                  'ZorgTypeAttribuutCode',
                  'ZorgTypeCluster[1]/ZorgTypeClusterItem[(@Key=1)]',
                  'ZorgTypeCluster[1]/ZorgTypeClusterItem[(@Key=2)]',
                  'BeginDatum',
                  'EindDatum',
                  'VersieDatum']
        ...
        xpaths = ['SpecialismeCode',
                  ...
                  'ZorgVraagOmschrijving',
                  'ZorgVraagAttribuutCode',
                  'ZorgVraagCluster[1]/ZorgVraagClusterItem[(@Key=1)]',
                  'ZorgVraagCluster[1]/ZorgVraagClusterItem[(@Key=2)]',
                  'BeginDatum',
                  'EindDatum',
                  'VersieDatum']
